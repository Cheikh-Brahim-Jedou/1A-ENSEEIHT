...
package LCA is
    ...
    function D_Valeur(Sda : in T_LCA) return T_Valeur ;
    
    function D_Cle(Sda : in T_LCA) return T_Cle ;
    
    procedure Depiler (Sda : in out T_LCA) ;
...
private
	...
	type T_Cellule ; -- Les Cellules de LCA 
    
    type T_LCA is access T_Cellule ; -- type pointeurs accés a T_Cellule
